...
import com.ibe.ibe_blitz_backend.dto.StandardRateResponseDto;
...
public class RoomDealsService {
    ...
    public RoomDealsResponseDto getRoomDeals(
            UUID roomTypeId,
            UUID propertyId,
            LocalDate checkIn,
            LocalDate checkOut,
        ...
        return RoomDealsResponseDto.builder()
    ...
    private void validate(
        ...
        LocalDate earliestAllowed = LocalDate.now().minusDays(1);
